...
export default function StartSessionDialog({ open, station, activeSession, isQuickGuest, isStandaloneTopup, onClose, showSnackbar, user }) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (isTopUp) {
        ...
        if (isRegistering) {
          const custId = await generateDisplayId("customers", "CU");
