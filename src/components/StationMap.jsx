...
export default function StationMap({ showSnackbar }) {
  ...
  return (
    <Box sx={{ height: '100%', display: 'flex', overflow: 'hidden', bgcolor: 'background.default' }}>
      ...
      />
      <EndSessionDialog open={endDialog.open} station={endDialog.station} session={endDialog.session} onClose={() => setEndDialog({ open: false, station: null, session: null })} showSnackbar={showSnackbar} />
